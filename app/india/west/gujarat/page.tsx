  ...
  return (
    <main className="min-h-screen bg-white text-slate-800">
      <section className="relative w-full h-[52vh] overflow-hidden">
        <Image src="/images/west-india/gujarat.jpg" alt="Gujarat" fill className="object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
        <div className="relative z-10 container mx-auto px-6 h-full flex items-end pb-12">
          <div className="text-white max-w-3xl">
            <h1 className="text-4xl font-extrabold">Gujarat</h1>
            <p className="mt-2 text-sm text-emerald-100">Salt marshes, desert festivals and Asiatic lion safaris.</p>
          </div>
        </div>
      </section>

      <section className="py-12 px-6 container mx-auto max-w-4xl">
        <h2 className="text-2xl font-bold mb-4">Gujarat at a glance</h2>
        <p className="text-gray-700 mb-4">
          Gujarat features Rann of Kutch, Gir National Park (Asiatic lions), and vibrant festivals and crafts in Ahmedabad and surrounding towns.
        </p>

        <ul className="mb-6 text-gray-700 list-disc pl-5 space-y-2">
          <li>Best season: Oct – Feb</li>
          <li>Top places: Ahmedabad, Rann of Kutch, Gir National Park</li>
          <li>Highlights: Festivals, wildlife safaris, salt marsh landscapes</li>
        </ul>
