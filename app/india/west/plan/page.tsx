...
const POPULAR_SPOTS: Record<(typeof WEST_STATES)[number], string[]> = {
  Goa: ["Panaji", "Calangute", "Anjuna", "Palolem"],
  Rajasthan: ["Jaipur", "Udaipur", "Jaisalmer", "Jodhpur", "Pushkar"],
  Gujarat: ["Ahmedabad", "Gir National Park", "Somnath", "Rann of Kutch"],
  Maharashtra: ["Mumbai", "Pune", "Aurangabad (Ellora/Ajanta)", "Lonavala", "Mahabaleshwar"],
  "Dadra and Nagar Haveli and Daman and Diu": ["Daman", "Diu", "Silvassa"],
};

export default function WestIndiaPlanTrip() {
  ...
  async function buildAIItinerary(): Promise<string> {
    ...
    const stateList = selectedStates.join(", ") || "West Indian states";
    const destinationList = allSpots.join(", ") || "West Indian highlights";

    const systemPrompt = `You are a professional travel planner for **JG Camps & Resorts**, specializing in West India.
Rules:
...
- End with a short summary encouraging users to contact JG Camps & Resorts for bookings.`;
    ...
    const userPrompt = `Plan a ${days}-day ${tripType || "West India"} itinerary.
States: ${stateList}
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-extrabold text-gray-900">Build Your West India Itinerary</h1>
        <p className="text-lg text-gray-600 mt-3">
          Create tailored plans across Goa, Rajasthan, Gujarat, Maharashtra and Daman & Diu — generated by AI & refined by JG Camps & Resorts.
          Contact us for bookings and personalized support.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto bg-white p-6 rounded-2xl shadow-lg">
        {!showItinerary ? (
          ...
          >
            ...
            {currentStep === 1 && (
              <Step title="What kind of trip?">
                {["Adventure", "Cultural", "Family", "Wellness", "Romantic", "Leisure"].map((t) => (
            ...
            {currentStep === 5 && (
              <div>
                ...
                <p className="text-xs text-gray-500 mt-3">AI will generate your custom West India itinerary.</p>
              </div>
            )}
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
            <h2 className="text-2xl font-bold mb-4 text-center">Your West India Itinerary</h2>
