  ...
  return (
    <main className="min-h-screen bg-white text-slate-800">
      <section className="relative w-full h-[52vh] overflow-hidden">
        <Image src="/images/east-india/bihar.jpg" alt="Bihar" fill className="object-cover" />
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-end pb-12">
          <div className="text-white max-w-3xl">
            ...
            <p className="mt-2 text-sm text-emerald-100 max-w-xl">
              Ancient heritage, Buddhist sites and Nalanda — Bodh Gaya, Patna and sacred trails.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 container mx-auto max-w-4xl">
        ...
        <ul className="list-disc ml-5 text-gray-700 space-y-2">
          <li>Bodh Gaya — Mahabodhi Temple and Buddhist pilgrimage.</li>
          <li>Nalanda ruins and archaeological sites.</li>
          <li>Patna — museums, Ganga ghats and markets.</li>
        </ul>
