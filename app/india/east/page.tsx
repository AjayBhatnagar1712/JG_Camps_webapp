...
const EAST_STATES: DestinationCard[] = [
  {
    name: "Bihar",
    image: "/images/east-india/bihar.jpg",
    bestSeason: "Oct – Mar",
    famousPlaces: ["Bodh Gaya", "Nalanda", "Patna"],
    highlights: "Ancient heritage, Buddhist sites, and vibrant local culture.",
  },
  {
    name: "Jharkhand",
    image: "/images/east-india/jharkhand.jpg",
    bestSeason: "Oct – Feb",
    famousPlaces: ["Ranchi", "Jamshedpur", "Betla National Park"],
    highlights: "Lush forests, waterfalls, and tribal traditions.",
  },
  {
    name: "Odisha",
    image: "/images/east-india/odisha.jpg",
    bestSeason: "Nov – Mar",
    famousPlaces: ["Puri", "Konark", "Bhubaneswar"],
    highlights: "Temple architecture, beaches, and classical Odissi art.",
  },
  {
    name: "West Bengal",
    image: "/images/east-india/west-bengal.jpg",
    bestSeason: "Oct – Mar",
    famousPlaces: ["Kolkata", "Darjeeling", "Sundarbans"],
    highlights: "Colonial charm, mountains, mangroves, and festivals.",
  },
  {
    name: "Andaman & Nicobar Islands",
    image: "/images/east-india/andaman.jpg",
    bestSeason: "Nov – May",
    famousPlaces: ["Port Blair", "Havelock Island", "Neil Island"],
    highlights: "Crystal beaches, coral reefs, and serene tropical escapes.",
  },
];
  ...
  return (
    <main className="bg-white text-slate-800">
      ...
      <section className="relative w-full h-[68vh] md:h-[72vh] overflow-hidden rounded-b-3xl shadow-lg">
        {/* Optional hero video if available */}
        <video
          className="absolute inset-0 w-full h-full object-cover"
          src="/videos/east_hero.mp4"
          autoPlay
          loop
          muted
          playsInline
          preload="metadata"
          poster="/images/east-india/east-hero.jpg"
        />
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-center">
          <div className="max-w-3xl text-white">
            ...
            >
              Explore <span className="text-amber-300">East India</span>
            </motion.h1>
            ...
            >
              From the ancient temples of Odisha to the beaches of Andaman — discover the cultural soul and natural beauty of Eastern India.
            </motion.p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <Link
                ...
                aria-label="Build itinerary for East India"
              >
                Build Itinerary
                <svg
                  className="w-4 h-4"
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Stat label="Cultural Sites" value="75+" />
              <Stat label="Beaches & Islands" value="20+" />
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold">
              Why visit East India?
            </h2>
            <p className="mt-3 text-lg text-gray-600 max-w-prose">
              East India is a treasure trove of ancient civilizations, tropical
              islands, classical art, and soulful spirituality — perfect for
              those seeking culture, history, and natural charm.
            </p>

            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Feature
                title="Cultural Heritage"
                text="Temples, monuments, and festivals celebrating centuries-old traditions."
              />
              <Feature
                title="Tropical Escapes"
                text="The pristine islands of Andaman offer diving, beaches, and serenity."
              />
              <Feature
                title="Spiritual Trails"
                text="Bodh Gaya, Jagannath Temple and more — centers of peace and devotion."
              />
              <Feature
                title="Cuisine & Arts"
                text="Authentic Bengali sweets, Odia seafood, and tribal arts await."
              />
            </ul>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl bg-gradient-to-tr from-white to-emerald-50 p-1">
            <div className="relative rounded-xl overflow-hidden h-72 sm:h-80">
              <Image
                src="/images/east-india/east-hero.jpg"
                alt="East India overview"
                fill
      ...
      <section className="py-16 px-6 bg-slate-50">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">
            Top East India Destinations
          </h2>

          <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            {EAST_STATES.map((dest) => (
              <motion.article
                key={dest.name}
                initial="offscreen"
                ...
                <div className="p-6">
                  ...
                  {dest.famousPlaces && (
                    <div className="text-sm text-gray-500 mb-4">
                      ...
                      {dest.famousPlaces.join(", ")}
                    </div>
                  )}

                  <div className="flex items-center justify-between gap-3">
                    <Link
                      href={`/india/east/${slugify(dest.name)}`}
        ...
        <div className="container mx-auto rounded-3xl bg-gradient-to-r from-amber-50/80 to-amber-100 p-8 shadow-md flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-2xl font-bold text-emerald-800">
              Ready to explore East India?
            </h3>
            <p className="mt-2 text-gray-700 max-w-xl">
              Share your travel dates and preferences — our experts will design
              a custom East India itinerary for you.
            </p>
          </div>
...
function Feature({ title, text }: { title: string; text: string }) {
  return (
    <div className="flex gap-4 items-start bg-white p-4 rounded-xl shadow-sm">
      <div className="h-10 w-10 rounded-md bg-emerald-50 grid place-items-center text-emerald-700 font-bold">
        ✓
      </div>
      <div>
