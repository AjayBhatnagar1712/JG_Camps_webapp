// app/india/northeast/<state>/page.tsx
"use client";
      ...
      <section className="container mx-auto px-6 py-12">
        ...
        <div className="flex flex-wrap gap-3 mt-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-lg border border-emerald-200 text-emerald-800 hover:bg-emerald-50"
          >
            ← Back to North East
          </Link>
        </div>
