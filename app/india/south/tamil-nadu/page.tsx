// app/india/south/tamil-nadu/page.tsx
"use client";
  ...
  return (
    <main className="min-h-screen bg-white text-slate-800">
      <section className="relative w-full h-[52vh] overflow-hidden">
        <Image src="/images/south-india/tamil-nadu.jpg" alt="Tamil Nadu" fill className="object-cover" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
        <div className="relative z-10 container mx-auto px-6 h-full flex items-end pb-12">
          <div className="text-white max-w-3xl">
            <motion.h1 className="text-4xl font-extrabold">Tamil Nadu</motion.h1>
            <p className="mt-2 text-sm text-emerald-100">Temple architecture, classical arts and coastal culture.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 container mx-auto max-w-4xl">
        ...
        <ul className="list-disc ml-5 text-gray-700 space-y-2">
          <li>Meenakshi Temple (Madurai) and ancient temple trails</li>
          <li>Pondicherry French Quarter and coastal promenades</li>
          <li>Chennai cultural scene and coastal cuisine</li>
        </ul>
