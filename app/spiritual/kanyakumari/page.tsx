...
export default function KanyakumariPage() {
  const title = "Kanyakumari";
  const region = "Tamil Nadu";
  const image = "/images/spiritual/kanyakumari.jpg";
  const blurb = "Southern tip of India — Vivekananda Rock Memorial, sunrise/sunset views and coastal shrines.";
