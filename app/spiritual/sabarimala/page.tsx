...
export default function SabarimalaPage() {
  const title = "Sabarimala";
  const region = "Kerala";
  const image = "/images/spiritual/sabarimala.jpg";
  const blurb = "Pilgrimage to Lord Ayyappa with seasonal restrictions and hill trek.";
  const bestSeason = "Nov–Jan";
