...
export default function ShirdiPage() {
  const title = "Shirdi (Sai Baba)";
  const region = "Maharashtra";
  const image = "/images/spiritual/shirdi.jpg";
  const blurb = "Pilgrimage town devoted to Sai Baba — deep communal faith and large darshan crowds.";
