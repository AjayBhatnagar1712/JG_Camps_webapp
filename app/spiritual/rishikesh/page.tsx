...
export default function RishikeshPage() {
  const title = "Rishikesh";
  const region = "Uttarakhand";
  const image = "/images/spiritual/rishikesh.jpg";
  const blurb = "Yoga capital with ashrams, meditation centers and river experiences.";
  const bestSeason = "Sep–Nov, Feb–Apr";
