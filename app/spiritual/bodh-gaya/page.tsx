...
export default function BodhGayaPage() {
  const title = "Bodh Gaya";
  const region = "Bihar";
  const image = "/images/spiritual/bodh-gaya.jpg";
  const blurb = "Where Lord Buddha attained enlightenment beneath the Bodhi Tree — a UNESCO World Heritage site.";
  const bestSeason = "Oct–Mar";
