...
export default function MaduraiPage() {
  const title = "Madurai (Meenakshi Amman)";
  const region = "Tamil Nadu";
  const image = "/images/spiritual/madurai.jpg";
  const blurb = "Grand Meenakshi temple complex with ornate gopurams and vibrant rituals.";
