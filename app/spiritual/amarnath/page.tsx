...
export default function AmarnathPage() {
  const title = "Amarnath Cave";
  const region = "Jammu & Kashmir";
  const image = "/images/spiritual/amarnath.jpg";
  const blurb = "High-altitude Shiva cave shrine with seasonal pilgrimage and spectacular Himalayan scenery.";
  const bestSeason = "Jun–Aug";
