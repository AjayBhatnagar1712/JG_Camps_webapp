...
export default function RameshwaramPage() {
  const title = "Rameshwaram";
  const region = "Tamil Nadu";
  const image = "/images/spiritual/rameshwaram.jpg";
  const blurb = "Ramanathaswamy Temple and sacred island pilgrimage — rich in mythology and ritual.";
  const bestSeason = "Nov–Mar";
