...
export default function HaridwarPage() {
  const title = "Haridwar";
  const region = "Uttarakhand";
  const image = "/images/spiritual/haridwar.jpg";
  const blurb = "Gateway to the Himalayas and the site of the holy Ganga aarti and Kumbh festivities.";
