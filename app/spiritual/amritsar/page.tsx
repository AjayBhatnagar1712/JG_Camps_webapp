...
export default function AmritsarPage() {
  const title = "Amritsar (Golden Temple)";
  const region = "Punjab";
  const image = "/images/spiritual/amritsar.jpg";
  const blurb = "Sri Harmandir Sahib — the spiritual and cultural center of Sikhism.";
