...
export default function VaishnoDeviPage() {
  const title = "Vaishno Devi";
  const region = "Jammu & Kashmir";
  const image = "/images/spiritual/vaishno-devi.jpg";
  const blurb = "Mountain shrine reached by a scenic trek to the holy cave of Mata Vaishno Devi.";
  const bestSeason = "Mar–Oct";
