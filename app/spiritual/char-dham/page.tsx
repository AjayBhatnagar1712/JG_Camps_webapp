...
export default function CharDhamPage() {
  const title = "Char Dham Yatra";
  const region = "Uttarakhand";
  const image = "/images/spiritual/char-dham.jpg";
  const blurb = "The sacred circuit of Yamunotri, Gangotri, Kedarnath and Badrinath — the quintessential Himalayan pilgrimage.";
  const bestSeason = "Apr–Oct";
